...
class JConstructorDeclaration extends JMethodDeclaration implements JMember {
    ...
    public JAST analyze(Context context) {
        ...
        if (!isStatic) { // if instance method
            // Offset 0 is used to address "this".
            this.context.nextOffset();
        }
        //converet list of exceptions (stored as typename object) into a list of their JVM names
        if(exceptions != null){
        ...
        for (JFormalParameter param : params) {
            ...
            if(param.type() == Type.LONG || param.type() == Type.DOUBLE){
                //same changes as analyze in jmethoddeclaration
    ...
    public void codegen(CLEmitter output) {
        //header
        //add string exception list in the header
